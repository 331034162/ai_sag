...
from ai_sag.doc_parser.word.v1.config import setup_logging, DEFAULT_OCR_BACKEND
from ai_sag.doc_parser.word.v1.models import WordResult, WordParagraph, WordTable, WordImage
from ai_sag.doc_parser.word.v1.table_handler import table_to_markdown
from ai_sag.doc_parser.word.v1.image_handler import (
...
class WordParser:
    ...
    def parse(self, file_path: str) -> WordResult:
        ...
        # 保存到磁盘
        if self.output_dir:
            from ai_sag.doc_parser.word.v1.formatter import save_markdown, save_text
