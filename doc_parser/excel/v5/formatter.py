...
from ai_sag.doc_parser.excel.v5.models import ExcelData

logger = logging.getLogger(__name__)


def print_summary(result: ExcelData):
    """打印解析摘要"""
    print("=" * 60)
...
def save_json(result: ExcelData, output_path: str,
